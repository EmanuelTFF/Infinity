...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $source = $_POST['source'];
    $admin = isset($_POST['admin']) ? 'sim' : 'nao';

    $sql = "INSERT INTO users (full_name, cpf, gender, birth_date, phone, email, password, source, administrador)
            VALUES ('$full_name', '$cpf', '$gender', '$birth_date', '$phone', '$email', '$password', '$source', '$admin')";
    ...
    <div class="container">
        ...
        <div class="right">
            ...
            <form method="post" action="register.php">
                ...
                <div class="checkbox-group">
                    <input type="checkbox" id="admin" name="admin" required>
                    <label for="terms">Sou administrador.</label>
                </div>
