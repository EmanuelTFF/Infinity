...
// Função para gerar um código de aprovação aleatór
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt_check->num_rows > 0) {
        ...
        // Verifica se é solicitação de administrador
        $admin_request = isset($_POST['admin']) ? 'yes' : 'no';
...
.gender-group, .admin-group {
    display: flex;
    gap: 20px;
    align-items: center;
}

.gender-input, .admin-input {
    display: flex;
    align-items: center;
}
